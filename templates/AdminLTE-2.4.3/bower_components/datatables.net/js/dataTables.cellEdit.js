...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    var style_textarea = "margin: 0px; width: 100%; height: 65px;";
    ...
    switch (inputType) {
        ...
        case "textarea-confirm":
            input.html = "<textarea id='ejbeatycelledit' class='" + inputCss + "' style='"+ style_textarea +"'>"+oldValue+"</textarea><br><a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>Confirm</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Cancel</a>";
            break;
        default: // text input
