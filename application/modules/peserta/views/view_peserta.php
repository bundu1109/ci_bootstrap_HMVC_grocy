    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Data Peserta Evaluasi Level 3 dan Level 4
                    ...
                    <div class="col-xs-12">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#all_peserta" data-toggle="tab">Data Peserta</a>
                                </li>
                                <li>
                                    <a href="#peserta_perPembelajaran" data-toggle="tab">Data Peserta Per Pembelajaran</a>
                                </li>
                                <li>
                                    <a href="#peserta_perUnitinduk" data-toggle="tab">Data Peserta Per Unit Induk</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="active tab-pane" id="all_peserta">
                                    <!-- box-header -->
                                    <div class="box">
                                        <div class="box-header">
                                            <h3 class="box-title">Data Peserta Evaluasi Level 3 dan Level 4</h3>
                                        </div>
                                        <!-- /.box-header -->
                                        <div class="box-body">

                                            <table id="data_peserta" class="table table-bordered table-striped responsive" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Nama</th>
                                ...
                                <div class="tab-pane" id="peserta_perPembelajaran">
                                    Minum
                                </div>
                                <div class="tab-pane" id="peserta_perUnitinduk">
                                    Makan
                                </div>
                            </div>
                        </div>
