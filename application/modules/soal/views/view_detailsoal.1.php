...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Data Detail Soal</h3>
                            ...
                            <div class="box-body">
                                ...
                                <div id="my"></div>
                                <input type='button' value='Test!' id="setDataButton">
    ...
    <script src="<?php  echo BASE_URL."/plugins/jexcel/exsternal/run_prettify.js" ?>"></script>

    <script src="<?php echo  BASE_URL; ?>/plugins/jexcel/dist/js/jquery.jexcel.js"></script>
    <script src="<?php echo  BASE_URL; ?>/plugins/jexcel/dist/js/jquery.jcalendar.js"></script>
    ...
    <script type="text/javascript">
     ...
     data = [
        ...
        $('#my').jexcel({
            //data:data,
            //url : 'http://localhost/ci_bootstrap_HMVC_grocy/a.json',
            url : 'http://localhost/ci_bootstrap_HMVC_grocy/soal/getjson',
            //csv : 'http://localhost/ci_bootstrap_HMVC_grocy/plugins/jexcel/examples/demo/demo1.csv',
            colHeaders:  [ 'Country', 'Description','coba','coba2','coba3'],
            colWidths: [ 30, 160, 200, 300, 100 ],
            columns: [
                /*
                { type: 'text' },
                { type: 'text' },
                { type: 'dropdown', source:[ {'id':'1', 'name':'Peserta'}, {'id':'2', 'name':'Atasan'} ] },
                { type: 'checkbox' },
                { type: 'calendar' },
                */
                { type: 'text' },
        ...
        $('#setDataButton').click(function () {
            data2 = [
                ['My car', 'Classe A', 1,1 ,'2006-01-01'],
                ['Test', 'Classe COK', 1,1 ,'2005-01-01']
            ];
