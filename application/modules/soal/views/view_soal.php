...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Data Soal Evaluasi Level 3</h3>
                            ...
                            <div class="box-body">
                                ...
                                <table id="data_soal" class="table table-bordered table-striped responsive" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th rowspan="2">No</th>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var dataTable = $('#data_soal').DataTable({
                "processing": true,
                "serverSide": true,
                "order": [],
                "ajax": {
                    url: "<?php echo base_url() . 'soal/fetch_user'; ?>",
                    type: "POST"
                },
                "columnDefs": [{
                    "targets": [0, 3, 4],
