...
<head>
  ...
  <title>Sistem Evaluasi Pembelajaran Terintegrasi | Dashboard
  </title>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/bower_components/bootstrap-daterangepicker/daterangepicker.css">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    <header class="main-header">
      ...
      <nav class="navbar navbar-static-top">
        ...
        <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#" class="sidebar-toggle" data-toggle="push-menu" role="button">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown messages-menu">
              <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="footer">
                  <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">See All Messages</a>
                </li>
              </ul>
            </li>
            ...
            <li class="dropdown notifications-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="footer">
                  <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">View all</a>
                </li>
              </ul>
            </li>
            ...
            <li class="dropdown tasks-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="footer">
                  <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">View all tasks</a>
                </li>
              </ul>
            </li>
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-body">
                  <div class="row">
                    <div class="col-xs-4 text-center">
                      <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">Followers</a>
                    </div>
                    <div class="col-xs-4 text-center">
                      <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">Sales</a>
                    </div>
                    <div class="col-xs-4 text-center">
                      <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">Friends</a>
                    </div>
                  </div>
                  <!-- /.row -->
                </li>
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#" class="btn btn-default btn-flat">Profile</a>
                  </div>
                  <div class="pull-right">
                    <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
            ...
            <li>
              <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#" data-toggle="control-sidebar">
        ...
        <div class="row">
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
              ...
              <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#" class="small-box-footer">More info
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="nav-tabs-custom">
              ...
              <ul class="nav nav-tabs pull-right">
                <li class="active">
                  <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#revenue-chart" data-toggle="tab">Area</a>
                </li>
                <li>
                  <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#sales-chart" data-toggle="tab">Donut</a>
                </li>
            ...
            <div class="box box-success">
              ...
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <img src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/dist/img/user4-128x128.jpg" alt="user image" class="online">
                  <p class="message">
                    <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#" class="name">
                      <small class="text-muted pull-right">
                        <i class="fa fa-clock-o"></i> 2:15</small> Mike Doe </a> I would like to meet you to discuss the latest news about the arrival
                    of the new theme. They say it is going to be one the best themes on the market
                  </p>
                  <div class="attachment">
                    <h4>Attachments:</h4>
                    <p class="filename"> Theme-thumbnail-image.jpg
                    </p>
                    <div class="pull-right">
                ...
                <!-- chat item -->
                <div class="item">
                  <img src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/dist/img/user3-128x128.jpg" alt="user image" class="offline">
                  <p class="message">
                    <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#" class="name">
                      <small class="text-muted pull-right">
                        <i class="fa fa-clock-o"></i> 5:15</small> Alexander Pierce </a> I would like to meet you to discuss the latest news about
                    the arrival of the new theme. They say it is going to be one the best themes on the market
                  </p>
                </div>
                <!-- /.item -->
                <!-- chat item -->
                <div class="item">
                  <img src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/dist/img/user2-160x160.jpg" alt="user image" class="offline">
                  <p class="message">
                    <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#" class="name">
                      <small class="text-muted pull-right">
                        <i class="fa fa-clock-o"></i> 5:30</small> Susan Doe </a> I would like to meet you to discuss the latest news about the arrival
                    of the new theme. They say it is going to be one the best themes on the market
                  </p>
                </div>
                <!-- /.item -->
              ...
              <div class="box-header">
                ...
                <div class="box-tools pull-right">
                  <ul class="pagination pagination-sm inline">
                    <li>
                      <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">&laquo;</a>
                    </li>
                    <li>
                      <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">1</a>
                    </li>
                    <li>
                      <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">2</a>
                    </li>
                    <li>
                      <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">3</a>
                    </li>
                    <li>
                      <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">&raquo;</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="box-body">
                ...
                <ul class="todo-list">
                  <li>
                    ...
                    <!-- todo text -->
                    <span class="text">Design a nice theme
                    </span>
                    <!-- Emphasis label -->
                  ...
                  <li>
                    ...
                    <input type="checkbox" value="">
                    <span class="text">Make the theme responsive
                    </span>
                  ...
                  <li>
                    ...
                    <input type="checkbox" value="">
                    <span class="text">Check your messages and notifications
                    </span>
                ...
                <div class="pull-right box-tools">
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li>
                        <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">Add new event</a>
                      </li>
                      <li>
                        <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">Clear events</a>
                      </li>
                      <li class="divider">
                      </li>
                      <li>
                        <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#">View calendar</a>
                      </li>
                    </ul>
                  </div>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2014-2016
        <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/https://adminlte.io">Almsaeed Studio</a>.</strong> All rights reserved.
    </footer>
    <!-- Control Sidebar -->
    <aside class="control-sidebar control-sidebar-dark">
      ...
      <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
        <li>
          <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#control-sidebar-home-tab" data-toggle="tab">
            <i class="fa fa-home"></i>
          </a>
        </li>
        <li>
          <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/#control-sidebar-settings-tab" data-toggle="tab">
            <i class="fa fa-gears"></i>
          </a>
        </li>
      </ul>
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane" id="control-sidebar-home-tab">
          ...
          <ul class="control-sidebar-menu">
            <li>
              <a href="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/javascript:void(0)">
  ...
  <!-- jQuery UI 1.11.4 -->
  <script src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/bower_components/jquery-ui/jquery-ui.min.js"></script>
  ...
  <!-- Morris.js charts -->
  <script src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/bower_components/raphael/raphael.min.js"></script>
  <script src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/bower_components/morris.js/morris.min.js"></script>
  <!-- Sparkline -->
  <script src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
  <!-- jvectormap -->
  <script src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
  <script src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
  <!-- jQuery Knob Chart -->
  <script src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
  <!-- daterangepicker -->
  <script src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/bower_components/moment/min/moment.min.js"></script>
  <script src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
  <!-- datepicker -->
  <script src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
  <!-- Bootstrap WYSIHTML5 -->
  <script src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
  <!-- Slimscroll -->
  ...
  <script src="<?php echo BASE_URL() ?>templates/AdminLTE-2.4.3/dist/js/pages/dashboard.js"></script>
